...
namespace mtc {
	namespace NumericConv {
		...
		template<class CharT> std::basic_string<CharT> ToString(unsigned int src, const int base = 10) {
			std::basic_string<CharT> tempStr;
			switch (base) {
			case 10:
		...
		template<class CharT> std::basic_string<CharT> ToString(char src, const int base = 10) {
			std::basic_string<CharT> tempStr;
			switch (base) {
			case 10:
				_private::Integer2CharT_10_signed(tempStr, src);
		...
		template<class CharT> std::basic_string<CharT> ToString(unsigned char src, const int base = 10) {
			std::basic_string<CharT> tempStr;
			switch (base) {
			case 10:
				_private::Integer2CharT_10_unsigned(tempStr, src);
		...
		template<class CharT> std::basic_string<CharT> ToString(short src, const int base = 10) {
			std::basic_string<CharT> tempStr;
			switch (base) {
			case 10:
				_private::Integer2CharT_10_signed(tempStr, src);
		...
		template<class CharT> std::basic_string<CharT> ToString(unsigned short src, const int base = 10) {
			std::basic_string<CharT> tempStr;
			switch (base) {
			case 10:
				_private::Integer2CharT_10_unsigned(tempStr, src);
		...
		template<class CharT> std::basic_string<CharT> ToString(long src, const int base = 10) {
			std::basic_string<CharT> tempStr;
			switch (base) {
			case 10:
				_private::Integer2CharT_10_signed(tempStr, src);
		...
		template<class CharT> std::basic_string<CharT> ToString(unsigned long src, const int base = 10) {
			std::basic_string<CharT> tempStr;
			switch (base) {
			case 10:
				_private::Integer2CharT_10_unsigned(tempStr, src);
		...
		template<class CharT> std::basic_string<CharT> ToString(long long src, const int base = 10) {
			std::basic_string<CharT> tempStr;
			switch (base) {
			case 10:
				_private::Integer2CharT_10_signed(tempStr, src);
		...
		template<class CharT> std::basic_string<CharT> ToString(unsigned long long src, const int base = 10) {
			std::basic_string<CharT> tempStr;
			switch (base) {
			case 10:
				_private::Integer2CharT_10_unsigned(tempStr, src);
		...
		template<class CharT> std::basic_string<CharT> ToString(float src, const int base = 10) {
			std::basic_string<CharT> tempStr;
			return tempStr;
		}

		template<class CharT> std::basic_string<CharT> ToString(double src, const int base = 10) {
			std::basic_string<CharT> tempStr;
			return tempStr;
		}

		template<class CharT> std::basic_string<CharT> ToString(long double src, const int base = 10) {
			std::basic_string<CharT> tempStr;
			return tempStr;
		}
		...
		/**
			ÉeÉìÉvÉåÅ[ÉgâªÇµÇΩstoånÇÃï∂éöóÒ-êîílïœä∑ä÷êî
			@param str stringå^ÇÃï∂éöóÒ
			@param idx ïœä∑Ç…égópÇ≥ÇÍÇ»Ç©Ç¡ÇΩóvëfÇÃÉCÉìÉfÉbÉNÉXÇÃë„ì¸êÊ
			@param base êÆêîÇÃêîílïœä∑Ç…Ç®ÇØÇÈêîílÇÃäÓêî
			@return ïœä∑åãâ ÇÃêîíl
			@todo charÇ‚wchar_tà»äOÇÃï∂éöÇàµÇ¶ÇÈÇÊÇ§Ç…ÇµÇ»ÇØÇÍÇŒÇÁÇ»Ç¢
		*/
		...
		*/
		...
		/**
			long longå^Ç≈ì¡éÍâªÇµÇΩToNumeric
		*/
		...
		/**
			unsigned longå^Ç≈ì¡éÍâªÇµÇΩToNumeric
		*/
		...
		/**
			unsigned long longå^Ç≈ì¡éÍâªÇµÇΩToNumeric
		*/
		...
		*/
		...
		/**
			long doubleå^Ç≈ì¡éÍâªÇµÇΩToNumeric
		*/
		...
		*/
		...
		/**
			unsinged long longå^Ç≈ì¡éÍâªÇµÇΩToNumeric
		*/
